...
// Sukurti masyvą, kurio ilgis būtų nuo 20 iki 30, o reikšmės būtų skaičiai nuo 10 iki 30.
...
// Sugeneruokite masyvą, kurio reikšmės atsitiktinės raidės A, B, C ir D, o ilgis 100.
...
const checkIsGoodNumber = (num) => {
  if (typeof num === 'number' && (isFinite(num) || num % 1 === 0 || num < 0)) {
    return true
  } else {
    return false
  }
...
const pirminisSkaicius = (a) => {
  ...
  if (typeof a === 'number' && isFinite(a) && a % 1 === 0 && a > 0) {
    for (let i = 1; i <= a; i++) {
      // console.log(i)
      a % i === 0 ? dalikliuKiekis++ : null
    }
  } else {
    return 'Pateiktas parametras nera tinkamas skaicius'
  }
...
console.log(pirminisSkaicius('a'), '--->', 'ERR')
console.log(pirminisSkaicius([1]), '--->', 'ERR')
console.log(pirminisSkaicius(5), '--->', 'Pirminis')
console.log(pirminisSkaicius(1), '--->', 'Ne')
console.log(pirminisSkaicius(4), '--->', 'Ne')
console.log(pirminisSkaicius(12), '--->', 'Ne')
console.log(pirminisSkaicius(123), '--->', 'Pirminis')
console.log(pirminisSkaicius(1.23), '--->', 'ERR')
console.log(pirminisSkaicius(-2), '--->', 'ERR')
  ...
  if (arr.length !== 10) {
    ...
    for (i = 0; i < arr.length; i++) {
      if (typeof arr[i] !== 'number' || !isFinite(arr[i])) {
        ...
        return 'Skaicius turi buti tarp 0 ir 9'
      } else if (arr[i] % 1 !== 0) {
        return 'Skaicius negali buti su kableliu'
      }
...
console.log(telefonoNumeris([3, 7, 0, 6, 7, 3, 3, 'NaN', 2, 0]))
console.log(telefonoNumeris([3, 7, 0, 6, 7, 3, 3, Infinity, 2, 0]))
console.log(telefonoNumeris([3, 7, 0, 6, 7, 3, 3, -Infinity, 2, 0]))
console.log(telefonoNumeris([3, 7, 0, 6, 7, 3, 3, 100, 2, 0]))
console.log(telefonoNumeris([3, 7, 0, 6, 7, 3, 3, -1, 2, 0]))
console.log(telefonoNumeris([3, 7, 0, 6, 7, 3, 3, 1.1, 2, 0]))
